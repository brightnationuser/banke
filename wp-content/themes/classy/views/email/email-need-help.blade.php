    ...
    <table class="email-template__table-top">
        <tr>
            <td>
                ...
                <div class="email-template__title email-template__center">Help Request</div>
                <div class="email-template__user-info">
                    <div class="user-info__username">From: {{ $post['username'] }} </div>
                    <div class="user-info__user-email">Email: {{ $post['email'] }}</div>
                    <div class="user-info__user-message">Message: {{ $post['message'] }}</div>
                </div>
            </td>
        </tr>
    </table>
