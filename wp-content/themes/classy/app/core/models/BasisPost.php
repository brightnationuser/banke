...
class BasisPost extends Basis {
    ...
    public function getAcfByKey($key) {
        //Второй раз натыкаюсь! ACF сначала надо включить в админке!!!
    ...
    public function getDate($format = 'd F Y')
    {
        return General::getFormattedDate($this->getAcfByKey('acf_date'), $format);
    }

    public function getPostDate($format = 'd F Y')
    {
    ...
    {
        return General::getFormattedDate($this->getAcfByKey('acf_time'), 'H:i'); //g:i a
    }
