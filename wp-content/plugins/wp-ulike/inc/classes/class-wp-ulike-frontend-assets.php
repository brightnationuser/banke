...
if ( ! class_exists( 'wp_ulike_frontend_assets' ) ) {
	...
	class wp_ulike_frontend_assets {
	  	...
	  	public function load_styles() {
	        ...
	        wp_enqueue_style( 'wp-ulike', WP_ULIKE_ASSETS_URL . '/css/wp-ulike.min.css', array(), '3.5.0' );
	     ...
	     */
	  	public function load_scripts() {
	        ...
	        wp_enqueue_script( 'wp_ulike', WP_ULIKE_ASSETS_URL . '/js/wp-ulike.min.js', array( 'jquery' ), '3.5.0', true );
